 ...
 *  Modified:        2015-05-12 Axel Isaksson (Adapted for TrollOS)$
 *  
...
#define putDebugChar debug_put_byte	/* write a single character      */
#define getDebugChar debug_get_byte	/* read and return a single char */

#define exceptionHandler int_set_handler  /* assign an exception handler */

void _hook(int arg) {
	
}

ExceptionHook exceptionHook = _hook;  /* hook variable for errors/exceptions */
...
");                                                                     
        RESTORE_FP_REGS()                                              
   __asm__("   moveml  registers,%d0-%d7/%a0-%a6");			        
